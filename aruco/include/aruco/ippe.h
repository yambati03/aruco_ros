...
private:
     ...
     */
    void solveGeneric(
      cv::InputArray _objectPoints, cv::InputArray _normalizedImagePoints,
    ...
    void solveCanonicalForm(
      cv::InputArray _canonicalObjPoints, cv::InputArray _normalizedInputPoints,
    ...
    void computeTranslation(
      cv::InputArray _objectPoints, cv::InputArray _normalizedImgPoints,
    ...
    void computeRotations(
      double j00, double j01, double j10, double j11, double p,
    ...
    void homographyFromSquarePoints(
      cv::InputArray _targetPoints, double halfLength,
      cv::OutputArray _H);
     ...
     */
    void makeCanonicalObjectPoints(
 ...
 */
  void normalizeDataIsotropic(
    cv::InputArray Data, cv::OutputArray DataN, cv::OutputArray T,
    cv::OutputArray Ti);
}  // namespace HomographyHO
